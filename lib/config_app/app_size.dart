...
class AppSize {
  ...
  static const double size_logo = 120;
  static const double size_thumb = 130;
  static const double size150 = 150;
  static const double size190 = 190;
  static const double size_header = 58;
  static const double size_latest = 140;
  static double sizeWidth40 = Get.width * 0.4;
  static double sizeHeight40 = Get.height * 0.4;
  static double sizeWidthApp = Get.width;
  static double sizeHeightApp = Get.height;
  static double sizeHeightStats = Get.height * 0.4;
  static double sizeWidthhButton = Get.width * 0.45;
}
