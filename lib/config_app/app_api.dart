...
class AppApi {
  ...
  static const String teamNameAway = 'teamNameAway';
  static const String teamNameHome = 'teamNameHome';
  ...
  //league Id
  static String leagueMain =
      LocalStorageService().getString('leagueId') ?? '339';
