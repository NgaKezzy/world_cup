...
import 'package:worldcup_app/home_page/view/more/widgets/item_foodball.dart';
import 'package:worldcup_app/home_page/view/more/widgets/item_stack_detail.dart';

class EventFoodball extends StatelessWidget {
  const EventFoodball({super.key});
    ...
    return SingleChildScrollView(
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Stack(
          ...
          children: [
            Container(
              height: AppSize.size100 * 4,
              width: AppSize.sizeWidthApp,
              decoration: const BoxDecoration(
                image: DecorationImage(
                    image: AssetImage('assets/images/chelsea4.jpg'),
                    fit: BoxFit.cover),
              ),
            ),
            Positioned(
              top: AppSize.size100 * 1.1,
              child: Container(
        ...
        Container(
          ...
          child: Column(children: [
            ItemStackDetail(cl: AppColors.purple, name: "NoRoomForRacism".tr),
