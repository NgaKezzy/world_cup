...
class GoalsTeam extends StatefulWidget {
  const GoalsTeam({super.key});

  @override
  State<GoalsTeam> createState() => _GoalsTeamState();
}

class _GoalsTeamState extends State<GoalsTeam> {
  @override
