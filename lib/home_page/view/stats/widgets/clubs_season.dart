...
class ClubsSeason extends StatefulWidget {
  const ClubsSeason({super.key});

  @override
  State<ClubsSeason> createState() => _ClubsSeasonState();
}

class _ClubsSeasonState extends State<ClubsSeason> {
  @override
