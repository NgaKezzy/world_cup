...
class ItemLastestFullTime extends StatelessWidget {
  const ItemLastestFullTime({super.key});
          ...
          child: Column(children: [
            ...
            Container(
              ...
              child: const TextCustom(
                text:
                    'By default, the linked page this, you must specify another target for the',
